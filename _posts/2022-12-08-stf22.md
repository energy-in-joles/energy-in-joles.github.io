...
Now that we have found our vulnerability and target, we can craft a very simple in-line javascript payload to redirect users to dump their cookies with some ideas from [here](https://book.hacktricks.xyz/pentesting-web/content-security-policy-csp-bypass) and [here](https://github.com/R0B1NL1N/WebHacking101/blob/master/xss-reflected-steal-cookie.md)
...
We are all ready! Let's upload the payload.

...
Searching online, I found the [`Encoder.h`](https://github.com/PaulStoffregen/Encoder/tree/master) header that reads the encoder output as a [finite state machine](https://www.doublejumpelectric.com/notes/embedded/rotary_encoder/rotary_encoder/index.html). This change in code had a significant impact on the readings, where they were now highly reliable and consistent.
